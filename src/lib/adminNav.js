...
export const adminNavGroups = [
  {
    label: "Register Control", icon: Monitor, items: [
      ...
      { label: "Customer Display", path: "/admin/customer-display", icon: MonitorPlay },
  ...
  },
  {
    label: "Sales & Inventory", icon: ShoppingCart, items: [
      ...
      { label: "Cheque Register", path: "/admin/check-register", icon: Banknote },
      { label: "Customer Service", path: "/admin/customer-service", icon: Headphones },
      ...
      { label: "Financials & Budget", path: "/admin/financials", icon: Scale },
    ],
  },
  {
  ...
  },
  {
    label: "Setup & Config", icon: Settings, items: [
      ...
      { label: "Technical Documentation", path: "/admin/technical-docs", icon: BookOpen },
    ],
  },
];

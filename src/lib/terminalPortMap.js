...
export const TERMINAL_PORT_MAPS = [
  {
    ...
    ports: [
      ...
      { id: "USB1", label: "USB", kind: "usb", volts: "5V", device: "SurePoint monitor hub — touch panel, IBM 3AA01194300 keyboard AND Zebra DS4308 scanner", node: "—", note: "All three peripherals reach the terminal through this single hub cable. Scanner is USB HID keyboard-wedge, no driver." },
      { id: "USB2", label: "USB", kind: "usb", volts: "5V", device: "Spare / technician USB", node: "—", note: "Free — used for a keyboard or stick during service." },
  ...
  },
  {
    ...
    ports: [
      ...
      { id: "USB1", label: "USB", kind: "usb", volts: "5V", device: "SurePoint monitor hub — touch panel, IBM 3AA01194300 keyboard AND Zebra DS4308 scanner", node: "—", note: "One hub cable carries all three. Panel stays IBM SurePoint — no Elo touch driver anywhere." },
      { id: "USB2", label: "USB", kind: "usb", volts: "5V", device: "Spare / technician USB", node: "—", note: "Free — used for a keyboard or stick during service." },
